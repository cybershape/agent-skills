---
name: code-symbols
description: Find and edit symbols in code using ast-grep (tree-sitter based). Use when finding function definitions, class definitions, symbol usages, renaming symbols, or replacing code in JavaScript, TypeScript, Python, Go, Rust, and other languages. NOT for Clojure - use clojure-symbols instead.
...
**Important:** Clojure is NOT supported. Use the `clojure-symbols` skill for Clojure code.
