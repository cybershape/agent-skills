...
**Setup:** No setup required — this skill only generates `.excalidraw` JSON files.
...
### Step 6: Final JSON Review

After generating the JSON, read through the complete file and check for issues — text clipped by containers, elements overlapping, arrows landing on the wrong elements, uneven spacing, unbalanced composition. Edit the JSON to fix anything you find before delivering.
...
Fix any alignment or binding issues.
...
### Visual Quality (JSON Review)
21. **No text overflow**: All text fits within its container
22. **No overlapping elements**: Shapes and text don't overlap unintentionally
23. **Even spacing**: Similar elements have consistent spacing
24. **Arrows land correctly**: Arrows connect to intended elements without crossing others
25. **Balanced composition**: No large empty voids or overcrowded regions
